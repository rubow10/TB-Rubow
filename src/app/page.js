    ...
    <main className="min-h-screen bg-gray-900 text-white flex flex-col justify-center items-center px-4 py-12 relative">
      ...
      {[
        ...
        >
          ...
          ) : text.includes("21310094") ? (
            <>
              You can contact me at{" "}
              <a href="tel:21310094" className="underline">21310094</a> or{" "}
              <a href="mailto:rubow10@gmail.com" className="underline">rubow10@gmail.com</a> if you'd like me to analyze your birth chart.
            </>
          ) : (
            text
          )}
